...
df = pd.read_csv(r'F:/svc/2023/Westwind/2023_July_westwind/2023_07_24_westwind_svc/tomato/2023_07_24_westwind_svc_tomato.csv')
df = df.transpose() 
df = df.iloc[1:, :]
...
# Optionally, you can add sample IDs or labels to the cleaned_samples_df if needed

# Save the cleaned samples to a new CSV file
cleaned_samples_df.to_csv(r'F:/svc/2023/Westwind/2023_July_westwind/2023_07_24_westwind_svc/tomato/2023_07_24_westwind_svc_tomato_interpolated.csv', index=False)